...
const customerProfile = props.loggedInUser?.data?.customer_profile || {};
const sliderValue = ref(customerProfile.hourly_rate || 250);

const form = useForm({
    nid_number: customerProfile.nid_number || '',
    skills: customerProfile.skills || '',
    experience: customerProfile.experience || '',
    district_id: customerProfile.district_id || '',
    zila_id: customerProfile.zila_id || '',
    upozila_id: customerProfile.upozila_id || '',
    bio: customerProfile.bio || '',
    hourly_rate: sliderValue.value,
    nid_front: customerProfile.nid_front || '',
    nid_back: customerProfile.nid_back || '',
...
const submit = () => {
    ...
    form.post(route('customer.profile.update', props.loggedInUser.data.id), {
        data: submitData,
        onSuccess: (response) => {
