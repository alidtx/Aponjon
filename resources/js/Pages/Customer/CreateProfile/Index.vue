                                   ...
                                   <div class="mb-4">
                                          ...
                                          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                 <div>
                                                        ...
                                                        <TextInput type="text" v-model="props.loggedInUser.data.name"
                                                               class="w-full p-3" placeholder="আপনার পূর্ণ নাম লিখুন"
                                                               readonly="true" />
                                                 </div>
                                                 <div>
                                                        <InputLabel for="number" value="মোবাইল নম্বর" />
                                                        <TextInput v-model="props.loggedInUser.data.phone"
                                                               class="w-full p-3" placeholder="আপনার ফোন নম্বর লিখুন"
                                                               readonly="true" />
                                                 </div>
                                                 <div>
                                                        <InputLabel for="email" value="ইমেইল" required />
                                                        <TextInput v-model="props.loggedInUser.data.email" type="email"
                                                               class="w-full p-3" placeholder="আপনার ইমেইল লিখুন"
                                                               readonly="true" />
                                                 </div>
                                                 <div>
                                                        <InputLabel for="nid_number" value="এনআইডি নম্বর" required />
                                                        <BaseNumberInput v-model="form.nid_number"
                                                               :error="form.errors.nid_number" type="number"
                                                               class="w-full p-3"
