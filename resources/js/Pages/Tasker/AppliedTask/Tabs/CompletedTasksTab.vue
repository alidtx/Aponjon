...
<template>
    <div>
        ...
        <div v-else-if="!completedTasks || completedTasks.length === 0" class="text-center py-12">
            <p class="text-gray-500">কোন কমপ্লিটেড কাজ নেই</p>
        </div>
        <div v-else class="space-y-4">
            <div v-for="bid in completedTasks" :key="bid.id" class="border border-red-200 rounded-lg p-4 bg-red-50">
                <div class="flex justify-between items-start mb-3">
                    ...
                    <span class="bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm">কমপ্লিটেড</span>
                </div>
                ...
                <div class="flex justify-between items-center mb-3">
                    ...
                    <div class="text-sm text-gray-600">
                        সম্পন্ন: {{ formatDate(bid.updated_at || bid.created_at) }}
                    </div>
                </div>
