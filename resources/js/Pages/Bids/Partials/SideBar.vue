            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 animate-fade-in">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-3xl font-bold text-dark mt-2">৳১,৫০০</p>
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-dark">১২ টি</span>
                        </div>
                        <div class="flex justify-between items-center">
                    ...
                    <button class="w-full bg-primary text-white py-3 rounded-lg hover:bg-blue-700 font-medium text-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 animate-fade-in">
                    ...
                    <button class="w-full mt-4 py-2 border border-primary text-primary rounded-lg hover:bg-blue-50 font-medium transition-colors">
                        সব বিড দেখুন
                    </button>
                </div>
