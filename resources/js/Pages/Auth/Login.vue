        ...
        <div class="text-center mb-8">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <form @submit.prevent="submit">
                    <div class="mb-4">
                        <InputLabel for="মোবাইল নম্বর বা ইমেইল" value="মোবাইল নম্বর বা ইমেইল" required />
                    ...
                    <div class="mb-4">
                        <InputLabel for="পাসওয়ার্ড" value="পাসওয়ার্ড" required />
                        <div class="relative">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <p class="text-gray-600 text-center">অ্যাকাউন্ট নেই?
                        <Link :href="route('register')" class="text-primary font-medium hover:underline">একটি অ্যাকাউন্ট তৈরি করুন</Link>
                    </p>
                </div>
            </div>
        </div>
